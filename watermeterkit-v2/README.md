...
Hardware version V2 is based on the **ESP8266**.
...
```yaml
packages:
  watermeterkit: github://smarthomeshop/watermeterkit/watermeterkit-v2/watermeterkit.yaml@main
```
...
V2 now includes a `Water Meter Initial Value` setting and an absolute `Water Meter Total` sensor.
